...
namespace PreviewDemo
{
    ...
    public class Preview : System.Windows.Forms.Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            this.textBoxIP.Text = "192.168.1.88";
            // 
            // textBoxPort
            // 
        ...
        private void btnJPEG_Click(object sender, EventArgs e)
        {
            ...
            ////BMP抓图 Capture a BMP picture
            //if (!CHCNetSDK.NET_DVR_CapturePicture(m_lRealHandle, sJpegPicFileName))
            //{
            //    iLastErr = CHCNetSDK.NET_DVR_GetLastError();
            //    str = "NET_DVR_CapturePicture failed, error code= " + iLastErr;
            //    MessageBox.Show(str);
            ...
            //else
            //{
            //    str = "Successful to capture the BMP file and the saved file is " + sJpegPicFileName;
            //    MessageBox.Show(str);
            //}
            //return;
            ...
            byte[] byJpegPicBuffer = new byte[3072 * 2048 * 4 + 100];
            ////int dwSizeReturned = 0;
            //int[] dwSizeReturned = new int[1];
            UInt32 sizeReturned = 0;

            if (!CHCNetSDK.NET_DVR_CapturePictureBlock_New(m_lRealHandle, byJpegPicBuffer, byJpegPicBuffer.Length, ref sizeReturned))
            {
            ...
            //else
            //{
            //       str = "Successful to capture the JPG file and the saved file is " + sJpegPicFileName;
            //    MessageBox.Show(str);
            //}
            //return;
